...
from app.core.repositories import UserRepository, EmailRepo, TokenRepository,TravellerProfileInterface, UserRolesPermissionsInterface, KycRepo, OnboardRepo, GuideProfileInterface, HostProfileInterface, PropertyRepo, UserManagementRepoInterface, TravellerHomePageRepositoryInterface, PropertyBookingsRepo
...
from app.infrastructure.repositories import TravellerProfileImpl, UserRolesPermissionsImpl, KycRepoImpl, OnboardRepoImpl, GuideProfileImpl, HostProfileImpl, SQLAlchemyUserRepository, CeleryEmailRepo, TokenRepositoryImpl, PropertyRepoImpl, UserManagementRepoImpl, HomePageRepositoryImpl, PropertyBookingsRepoImpl
...
async def get_booking_repo(
    db: DbDep,
)->PropertyBookingsRepo:
    return PropertyBookingsRepoImpl(db)
...
async def get_user_management_repo(
        db: DbDep
...
BookingRepoDep = Annotated[PropertyBookingsRepo, Depends(get_booking_repo)]
